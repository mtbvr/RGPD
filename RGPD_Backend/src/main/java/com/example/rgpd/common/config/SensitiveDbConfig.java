...
public class SensitiveDbConfig {
    ...
    @Bean
    public DataSourceInitializer sensitiveDataSourceInitializer() {
        ResourceDatabasePopulator populator = new ResourceDatabasePopulator();
        populator.addScript(new ClassPathResource("data-sensitive.sql"));

        DataSourceInitializer initializer = new DataSourceInitializer();
        initializer.setDataSource(sensitiveDataSource());
